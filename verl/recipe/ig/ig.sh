...
grpo_weight_enable=True
grpo_weight_beta=1.0
grpo_weight_entropy_clip=5.0
...
python3 -m verl.trainer.l2s_stage2_ig \
    ...
    algorithm.grpo_weighting.enable=${grpo_weight_enable} \
    algorithm.grpo_weighting.beta=${grpo_weight_beta} \
    algorithm.grpo_weighting.entropy_clip=${grpo_weight_entropy_clip} \
    algorithm.grpo_weighting.eps=${grpo_weight_eps} \
    algorithm.grpo_weighting.correct_threshold=${grpo_weight_correct_threshold} \
    ...
    +actor_rollout_ref.actor.grad_damping_gamma=${grad_damping_gamma} \
