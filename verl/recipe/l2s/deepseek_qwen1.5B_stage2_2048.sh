...
project_name='DAPO-2048'
exp_name='DAPO-deepseek-Qwen1.5B-stage2-2048'
...
WORKING_DIR=${WORKING_DIR:-"${PWD}"}
MODEL_PATH=${MODEL_PATH:-"${WORKING_DIR}/ckpts/DAPO-2048/DAPO-deepseek-Qwen1.5B-2048/global_step_600/actor_hf"}
