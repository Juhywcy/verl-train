...
project_name='DAPO-8192'
exp_name='DAPO-deepseek-Qwen1.5B-stage2-8192'
...
WORKING_DIR=${WORKING_DIR:-"${PWD}"}
MODEL_PATH=${MODEL_PATH:-"${WORKING_DIR}/ckpts/DAPO-8192/DAPO-deepseek-Qwen1.5B-8192/global_step_600/actor_hf"}
