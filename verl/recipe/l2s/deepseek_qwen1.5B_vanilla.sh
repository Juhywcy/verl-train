...
project_name='DAPO-vanilla'
exp_name='DAPO-deepseek-Qwen1.5B'
...
WORKING_DIR=${WORKING_DIR:-"${PWD}"}
MODEL_PATH=${MODEL_PATH:-"${RAY_DATA_HOME}/model/DeepSeek-R1-Distill-Qwen-1.5B"}
CKPTS_DIR=${CKPTS_DIR:-"/home/hrzhu/code/long2short/ckpts/${project_name}/${exp_name}"}
...
TRAIN_FILE=${TRAIN_FILE:-"/home/hrzhu/code/long2short/data/deepscaler/train.parquet"}
TEST_FILE=${TEST_FILE:-"/home/hrzhu/code/long2short/data/deepscaler/aime24_datasource.parquet"}
# Algorithm
temperature=1.0
top_p=1.0
