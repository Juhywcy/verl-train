...
project_name='DAPO'
exp_name='DAPO-deepseek-Qwen7B-stage2'
...
WORKING_DIR=${WORKING_DIR:-"${PWD}"}
MODEL_PATH=${MODEL_PATH:-"${WORKING_DIR}/ckpts/DAPO/DAPO-deepseek-Qwen7B-full/global_step_500/actor_hf"}
