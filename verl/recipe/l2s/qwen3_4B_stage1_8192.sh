...
MODEL_PATH=${MODEL_PATH:-"/home/hrzhu/code/long2short/ckpts/DAPO/DAPO-Qwen3-4B/global_step_50/actor_hf"}
WORKING_DIR=${WORKING_DIR:-"${PWD}"}
...
python3 -m verl.trainer.l2s \
    ...
    +actor_rollout_ref.model.override_config.max_position_embeddings=40960 \
