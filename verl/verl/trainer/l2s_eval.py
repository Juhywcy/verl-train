...
from verl.trainer.ppo.l2s_eval_trainer import RayPPOTrainer
...
class L2SRewardManager():
    ...
    def __call__(self, data: DataProto, return_dict=False):
        ...
        for i, score, valid_response_length in results:
            ...
            length_list.append(valid_response_length)
        if return_dict:
            return {
                "reward_tensor": reward_tensor,
                "reward_extra_info": reward_extra_info,
                "valid_length": length_list,
            }
        else:
...
class TaskRunner:
    def run(self, config):
        ...
        from verl.trainer.ppo.l2s_eval_trainer import ResourcePoolManager, Role
