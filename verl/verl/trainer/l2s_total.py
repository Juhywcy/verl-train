...
from verl.trainer.ppo.l2s_total_trainer import RayPPOTrainer
from verl.trainer.ppo.reward import load_reward_manager
from verl.utils.dataset.sampler import AbstractSampler
from verl.utils.import_utils import load_extern_type

from deepscaler.rewards.l2s_reward import deepscaler_reward_fn, Exponential_Decay
...
class TaskRunner:
    def run(self, config):
        ...
        from verl.trainer.ppo.l2s_total_trainer import ResourcePoolManager, Role
