            ...
            for batch_dict in self.train_dataloader:
                ...
                with marked_timer("step", timing_raw):
                    ...
                    with marked_timer("adv", timing_raw, color="brown"):
                        ...
                        # zhr
                        def norm_bylen(token_level_rewards, response_mask, index, max_response_length):   
                        ...
                        batch.batch["advantages"], batch.batch["returns"] = norm_bylen(token_level_rewards=batch.batch["token_level_rewards"],
