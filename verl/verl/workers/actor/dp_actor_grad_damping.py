...
"""
Single Process Actor with Gradient Damping (Entropy Correction)
"""
...
__all__ = ["DataParallelPPOActorGradDamping"]
    ...
    def _forward_micro_batch(
        ...
        with torch.autocast(device_type=self.device_name, dtype=torch.bfloat16):
            ...
            if self.use_remove_padding:
                ...
                extra_args = {}
                # Disable fused kernels if using damping
                use_fused_kernels = self.use_fused_kernels and (self.grad_damping_gamma == 0.0)
